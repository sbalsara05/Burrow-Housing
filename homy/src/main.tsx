...
try {
  ...
  rootElement.innerHTML = `
    <div style="padding: 20px; font-family: sans-serif; background: white; min-height: 100vh;">
      ...
      <p style="color: #333; margin-bottom: 8px;"><strong>Error:</strong> ${escapedMessage}</p>
      <details style="margin-top: 16px;">
        <summary style="cursor: pointer; color: #666; margin-bottom: 8px;">Show Stack Trace</summary>
        <pre style="background: #f5f5f5; padding: 10px; overflow: auto; border: 1px solid #ddd; border-radius: 4px; font-size: 12px;">${escapedStack}</pre>
      </details>
