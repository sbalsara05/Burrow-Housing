            ...
            <div className="row gx-xxl-5">
               {currentItems.map((item) => (
                  <div key={item.id} className="col-lg-4 col-sm-6">
                     <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30">
                        ...
                        <div className="logo-wrapper d-flex align-items-center justify-content-center">
                           <img src={item.thumb} alt="" className="lazy-img" />
                        </div>
                        <div className="text-center pt-35">
                           ...
                           <p>{item.desc}</p>
                           <Link to="/agency_details" className="btn-eight w-100 rounded-0 tran3s">View Listing</Link>
                        </div>
                     </div>
                  </div>
               ))}
