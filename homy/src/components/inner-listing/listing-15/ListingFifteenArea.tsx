               ...
               <div className="bg-light pl-40 pr-40 pt-35 pb-60">
                  <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
                     ...
                     <div className="d-flex align-items-center xs-mt-20">
                        ...
                        <Link to="/listing_15" className="tran3s layout-change rounded-circle ms-auto ms-sm-3"
                           data-bs-toggle="tooltip" title="Switch To List View"><i className="fa-regular fa-bars"></i></Link>
                     </div>
                  </div>

                  {currentItems.map((item: any) => (
                     <div key={item.id} className="listing-card-seven border-20 p-20 mb-35">
                        <div className="d-flex flex-wrap layout-one">
                           ...
                           <div className="property-info">
                              ...
                              <div className="feature2 fs-16 color-dark mt-20 mb-30 pb-5">
                                 <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                    <li className="d-flex align-items-center mt-15">
                                       <img src="/assets/images/icon/icon_04.svg" alt="" className="lazy-img icon me-2" />
                                       <span className="fs-16">{item.property_info.sqft} sqft</span>
                                    </li>
                                    <li className="d-flex align-items-center mt-15">
                                       <img src="/assets/images/icon/icon_05.svg" alt="" className="lazy-img icon me-2" />
                                       <span className="fs-16">{item.property_info.bed} sqft</span>
                                    </li>
                                    <li className="d-flex align-items-center mt-15">
                                       <img src="/assets/images/icon/icon_06.svg" alt="" className="lazy-img icon me-2" />
                              ...
                              <div className="pl-footer d-flex align-items-center justify-content-between">
                                 ...
                                 <Link to="/listing_details_05" className="btn-four rounded-circle"><i className="bi bi-arrow-up-right"></i></Link>
                              </div>
                           </div>
                        </div>
                     </div>
