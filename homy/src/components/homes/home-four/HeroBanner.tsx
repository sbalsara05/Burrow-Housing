...
import DropdownFour from "../../search-dropdown/home-dropdown/DropdownFour"

const banner_avatar = [
   "/assets/images/media/img_33.jpg",
   "/assets/images/media/img_34.jpg",
   "/assets/images/media/img_35.jpg",
   "/assets/images/media/img_36.jpg",
]
      ...
      <div className="hero-banner-four position-relative">
                  ...
                  <div className="col-lg-6">
                     <div className="mt-45">
                        <h1 className="hero-heading text-white fw-500">
                           ...
                           <span className="d-block d-lg-inline-flex">
                              {banner_avatar.map((img, i) => (
                                 <img key={i} src={img} alt="" className="lazy-img avatar" />
                              ))}
                           </span>
                        </h1>
                        ...
                        <div className="d-inline-flex flex-wrap align-items-center">
                           <Link to="/listing_01" className="btn-two rounded-0 border-0 mt-15 me-4"><span>Explore All</span></Link>
                           <Link to="/contact" className="btn-eight inverse mt-15"><span>Request a Callback</span> <i className="fa-sharp fa-light fa-arrow-right-long"></i></Link>
                        </div>
                     </div>
                  </div>

                  <div className="col-lg-5 col-lg-6 ms-auto">
                     <DropdownFour />
                  </div>
               </div>
            </div>
         ...
         <div className="social-elemnet">
            <ul className="style-none d-flex align-items-center">
               <li><Link to="#" className="tran3s">Fb.</Link></li>
               <li><Link to="#" className="tran3s">Tw.</Link></li>
               <li><Link to="#" className="tran3s">Inst.</Link></li>
            </ul>
         </div>
