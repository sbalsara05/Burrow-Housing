            ...
            <div className="row">
               <div className="col-xxl-5 col-lg-6 ms-auto order-lg-last">
                  <div className="pt-40 xl-pt-20 pb-110 xl-pb-60">
                     ...
                     <p className="fs-16 mt-10">For more details please <Link to="#" className="color-dark text-decoration-underline fst-italic">contact us</Link></p>
               ...
               <div className="col-lg-6">
                  <div className="media-gallery position-relative z-1 h-100">
                     <div className={`bg ${style ? "bg_2" : ""}`}>
                        ...
                        <img src="/assets/images/assets/screen_05.jpg" alt="" className="lazy-img screen_01" />
                     </div>
                  </div>
               </div>
            </div>
