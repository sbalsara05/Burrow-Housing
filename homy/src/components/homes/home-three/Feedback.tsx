         ...
         <div className={`container ${style ? "" : "container-large"}`}>
            <div className="position-relative z-1">
               <div className="row">
                  <div className="col-xl-6 col-lg-8">
                     <div className="title-one pe-xxl-5 mb-75 xl-mb-50">
                        {style ? <h3>Client <span>Feedback <img src="/assets/images/shape/title_shape_01.svg" alt="" className="lazy-img" /></span></h3> :
                           <h2 className="font-garamond">Don’t Trust Us, Trust <em>our clients</em> <span className="star-shape"><img src="/assets/images/shape/shape_37.svg" alt="" className="lazy-img" /></span></h2>}
               ...
               <div className="section-btn text-center md-mt-30">
                  <Link to="#" className="btn-eleven fst-italic"><span>See all Feedback</span></Link>
               </div>
            </div>
         </div>
         {!style && <><img src="/assets/images/shape/shape_42.svg" alt="" className="lazy-img shapes shape_01" />
            <img src="/assets/images/shape/shape_43.svg" alt="" className="lazy-img shapes shape_02" /></>}
      </div>
   )
}
