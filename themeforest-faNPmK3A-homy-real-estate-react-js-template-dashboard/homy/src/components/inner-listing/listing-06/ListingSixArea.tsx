                  ...
                  <div className="ps-xxl-5">
                     <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
                        ...
                        <div className="d-flex align-items-center xs-mt-20">
                           ...
                           <Link to="/listing_05" className="tran3s layout-change rounded-circle ms-auto ms-sm-3"
                        ...
                        <div key={item.id} className="listing-card-seven grey-bg mb-50">
                           <div className="d-flex flex-wrap layout-one">
                              ...
                              <div className="property-info pe-4 ps-4">
                                 <Link to="/listing_details_06" className="title tran3s mb-15">{item.title}</Link>
                                 ...
                                 <div className="pl-footer pb-15 d-flex flex-wrap align-items-center justify-content-between">
                                    ...
                                    <Link to="/listing_details_06" className="btn-four">
