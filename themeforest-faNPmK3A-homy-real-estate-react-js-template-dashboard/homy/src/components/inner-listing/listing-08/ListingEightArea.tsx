         ...
         <div className="container container-large">
            ...
            <div className={`listing-header-filter d-sm-flex justify-content-between align-items-center lg-mb-30 ${style ? "mb-50" : "mb-40"}`}>
               ...
               <div className="d-flex align-items-center xs-mt-20">
                  ...
                  <Link to={`/${style ? "listing_09" : "listing_07"}`} className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To Grid View"><i className="fa-regular fa-grid-2"></i></Link>
               </div>
            </div>

            {currentItems.map((item: any) => (
               <div key={item.id} className="listing-card-seven grey-bg mb-50">
                  <div className="d-flex flex-wrap layout-two">
                     ...
                     <div className="property-info">
                        <Link to="/listing_details_01" className="title tran3s mb-15">{item.title}</Link>
                        ...
                        <div className="pl-footer pb-15 d-flex flex-wrap align-items-center justify-content-between">
                           ...
                           <Link to="/listing_details_01" className="btn-four"><i className="bi bi-arrow-up-right"></i></Link>
                        </div>
                     </div>
                  </div>
               </div>
