            ...
            <div className="row">
               <div className="col-lg-6">
                  <div className="title-one md-mb-30 pe-xxl-4">
                     <h3 className="m0 text-white">Easily <span>Purchase,<img src="/assets/images/shape/title_shape_09.svg" alt="" className="lazy-img" /></span> Sell, or Lease listings.</h3>
                  </div>
               </div>
               <div className="col-xxl-5 col-lg-6 ms-auto">
                  <p className="text-white fs-24 m0 lh-lg ps-xxl-5">Your leading real estate advocate, transforming houses into dreams. Trust us to expertly guide you home</p>
               </div>
            </div>

            <div className="card-bg-wrapper mt-70 lg-mt-50">
               <div className="row">
