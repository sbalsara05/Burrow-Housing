...
const PropertyTwo = ({ style }: any) => {
   ...
   return (
      <div className="property-listing-four bg-pink-three position-relative z-1 overflow-hidden pt-120 xl-pt-80 pb-110 xl-pb-60 mt-170 xl-mt-140 lg-mt-120">
         <div className="container container-large">
            <div className="position-relative z-1">
               <div className="title-one mb-60 lg-mb-40">
                  <h2 className="font-garamond">New <em>Listings</em> <span className="star-shape"><img src="/assets/images/shape/shape_37.svg" alt="" className="lazy-img" /></span></h2>
                        ...
                        <div className="listing-card-one style-three border-30 mb-50">
                           <div className="img-gallery p-15">
                              <div className="position-relative border-20 overflow-hidden">
                                 ...
                                 <Link to="/listing_details_04" className="btn-four inverse rounded-circle position-absolute"><i className="bi bi-arrow-up-right"></i></Link>
                           ...
                           <div className="property-info pe-4 ps-4">
                              <Link to="/listing_details_04" className="title tran3s">{item.title}</Link>
               ...
               <div className="section-btn text-center">
                  <Link to="/listing_04" className="btn-eleven fst-italic"><span>See all properties</span></Link>
               </div>
         ...
         {!style &&
            <>
               <img src="/assets/images/shape/shape_38.svg" alt="" className="lazy-img shapes shape_01" />
