            ...
            <div className="bg-wrapper position-relative z-1 pt-85 lg-pt-70 pb-100 xl-pb-80 lg-pb-70">
               <div className="row">
                  <div className="col-xl-7 col-lg-8 col-md-10 m-auto text-center">
                     ...
                     <Link to="/about_us_01" className="btn-two"><span>Get Started</span></Link>
                  </div>
               </div>
               <img src="/assets/images/shape/shape_44.svg" alt="" className="lazy-img shapes shape_01" />
               <img src="/assets/images/shape/shape_44.svg" alt="" className="lazy-img shapes shape_02" />
            </div>
         </div>
      </div>
   )
