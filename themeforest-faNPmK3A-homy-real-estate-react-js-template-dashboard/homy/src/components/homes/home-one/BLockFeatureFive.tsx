...
const BLockFeatureFive = ({ style }: any) => {
   return (
      <div className={`block-feature-five position-relative z-1 pb-130 xl-pb-100 lg-pb-80 ${style ? " pt-170 xl-pt-120" : "bg-pink pt-100 lg-pt-80 mt-225 xl-mt-200 lg-mt-150"}`}>
            ...
            <div className="row">
               <div className="col-xl-8 m-auto">
                  <div className="title-one text-center mb-35 lg-mb-20">
                     <h3>We’r here to help <br /> you get your <span>dream home<img src="/assets/images/shape/title_shape_07.svg" alt="" className="lazy-img" /></span></h3>
                  ...
                  <div className="row gx-xl-5 justify-content-center">
                     {feature_data.filter((items) => items.page === "home_1_feature_3").map((item) => (
                        <div key={item.id} className="col-lg-4 col-sm-6">
                           <div className={`card-style-one text-center mt-40 ${item.class_name}`}>
         ...
         <img src="/assets/images/shape/shape_07.svg" alt="" className="lazy-img shapes shape_01" />
         <img src="/assets/images/shape/shape_08.svg" alt="" className="lazy-img shapes shape_02" />
      </div>
   )
}
