               ...
               <div className="col-lg-8">
                  <div className="service-post">
                     ...
                     <div className="img-gallery pt-15 pb-70 lg-pb-50">
                        <div className="row">
                           <div className="col-8">
                              <img src="/assets/images/media/img_57.jpg" alt="" className="lazy-img w-100 mt-20" />
                           </div>
                           <div className="col-4">
                              <img src="/assets/images/media/img_58.jpg" alt="" className="lazy-img w-100 mt-20" />
                           </div>
                        </div>
                     </div>
                              ...
                              {service_features.map((item, index) => (
                                 <div key={index} className="col-xl-4 col-lg-6 col-md-4">
                                    <div className="card-style-eleven mt-30">
                                       <div className="icon"><img src={item.icon} alt="" className="lazy-img" /></div>
                     ...
                     <Link to="/contact" className="btn-two mt-30">Contact Us</Link>
                  </div>
               </div>
                     ...
                     <div className="service-sidebar md-mt-80">
                        <div className="service-category">
                           <ul className="style-none">
                              <li><Link to="#" className="active">Buy Home</Link></li>
                              {sidebar_list.map((list, i) => <li key={i}><Link to="#">{list}</Link></li>)}
                           </ul>
                        </div>
                        <div className="contact-banner text-center mt-45">
                           <h4 className="mb-35 text-white">Any Questions? <br />Let’s talk</h4>
                           <Link to="/contact" className="btn-two">Let’s Talk</Link>
                        </div>
                     </div>
                  </div>
               </div>
