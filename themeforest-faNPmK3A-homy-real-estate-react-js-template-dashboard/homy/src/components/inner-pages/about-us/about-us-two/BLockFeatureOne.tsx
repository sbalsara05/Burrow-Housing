               ...
               <div className="col-xl-6 col-lg-7 order-lg-last">
                  <div className="ms-xxl-5 ps-xl-4 ps-lg-5 md-mb-50">
                     <div className="title-one mb-45 lg-mb-20">
                        <h2 className="font-garamond star-shape">Find Your Preferable Match Easily. <span className="star-shape"><img src="/assets/images/shape/shape_37.svg" alt="" className="lazy-img" /></span></h2>
                     </div>
                     ...
                     <Link to="contact" className="btn-five mt-75 lg-mt-50">Contact us</Link>
                  </div>
               </div>
               <div className="col-xl-6 col-lg-5 d-lg-flex">
                  <div className="media-block h-100 w-100 pe-xl-5">
                     <div className="bg-img position-relative" style={{ backgroundImage: `url(/assets/images/media/img_52.jpg)` }}>
                        <img src="/assets/images/assets/screen_10.png" alt="" className="lazy-img shapes screen_01" />
                     </div>
                  </div>
               </div>
            </div>
