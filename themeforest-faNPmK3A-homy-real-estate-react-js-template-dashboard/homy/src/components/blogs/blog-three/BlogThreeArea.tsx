                     ...
                     <div className="isotop-item villa sale">
                        <article className="blog-meta-one mb-70 lg-mb-40">
                           <figure className={`post-img border-25 position-relative m0 ${item.class_name}`}>
                              <Link to={`/blog_details/${item.id}`} className="stretched-link date tran3s">{item.date}</Link>
                           </figure>
                           <div className="post-data">
                              ...
                              <div className="d-flex justify-content-between align-items-sm-center flex-wrap">
                                 <Link to={`/blog_details/${item.id}`} className="blog-title">
                                    <h4>{item.title}</h4>
                                 </Link>
                                 <Link to={`/blog_details/${item.id}`} className="read-btn rounded-circle d-flex align-items-center justify-content-center tran3s">
